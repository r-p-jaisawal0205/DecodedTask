    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="profile_photo_path" class="block mt-1 w-full" type="file" name="profile_photo_path" :value="old('profile_photo_path')" />
            </div>

            <div class="mt-4">
                <x-jet-label for="gender" value="{{ __('Gender') }}" />
                <x-jet-input class="mt-1" type="radio" name="gender" :value="1" required /> Male.
                <x-jet-input class="mt-1" type="radio" name="gender" :value="2" required /> Female.
            </div>
